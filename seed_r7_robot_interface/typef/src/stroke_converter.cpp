...
(std::vector<int16_t>& _strokes, const std::vector<double>& _angles)
{
  ...
  _strokes[17]
    = static_cast<int16_t>(scale * setAngleToStroke(180 + rad2Deg * _angles[17], elbow_p.table));
...
(std::vector<double>& _angles, const std::vector<int16_t>& _strokes)
{
  ...
  _angles[17] = - M_PI + deg2Rad * setStrokeToAngle(scale_inv * _strokes[17], elbow_p.inv_table);
